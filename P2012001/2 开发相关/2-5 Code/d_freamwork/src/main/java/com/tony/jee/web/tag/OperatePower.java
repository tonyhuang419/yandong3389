...
public class OperatePower extends Component {
    ...
    /**
     * @param model 接收从PowerTag传过来的model值
     */
    ...
    /**
     * @param page 接收从PowerTag传过来的page值
     */
    ...
    /**
     * @param operate 接收从PowerTag传过来的operate值
     */
     ...
     * @param stack
     */
    public OperatePower(ValueStack stack) {
        super(stack);
    }
