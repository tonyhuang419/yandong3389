...
public interface BrowsingHistoryMapper {
     ...
     * 根据条件更新属性不为空的记录
     */
    int updateByExampleSelective(@Param("record") BrowsingHistory record, @Param("example") Criteria example);

    /**
     * 根据条件更新记录
     */
    int updateByExample(@Param("record") BrowsingHistory record, @Param("example") Criteria example);
