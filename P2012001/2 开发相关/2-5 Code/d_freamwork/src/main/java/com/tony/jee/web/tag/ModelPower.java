...
@StrutsTag(name = "modelpower", tldTagClass = "com.clbus.common.tag.ModelPowerTag", description = "权限标签")
public class ModelPower extends Component {
     ...
     * @param stack
     */
    public ModelPower(ValueStack stack) {
        super(stack);
    }
