...
@StrutsTag(name = "NotPagePower", tldTagClass = "com.clbus.common.tag.NotPagePowerTag", description = "权限标签")
public class NotPagePower extends Component {
     ...
     * @param stack
     */
    public NotPagePower(ValueStack stack) {
        super(stack);
    }
